		...
		function(data) {
			if(data.estado == 1){
				...
				$.each(Barrios, function(index, val) {
						cade = '';
						cade += '<option value="'+val.lis_id_barrio+'">'+val.lis_nombre+'</option>';
		...
		function(data) {		
			if(data.estado == 1){
				...
				$.each(Ciudades, function(index, val) {
						cade = '';
						cade += '<option value="'+val.lis_id_ciudad+'">'+val.lis_nombre+'</option>';
